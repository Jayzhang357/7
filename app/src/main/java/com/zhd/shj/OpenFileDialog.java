...
public class OpenFileDialog {
    ...
    public static CustomDialog createDialog(int id, Context context,
                                            String title, CallbackBundle callback, String suffix,
                                            String headstr, Map<String, Integer> images) {
        CustomDialog.Builder builder = new CustomDialog.Builder(context);
        builder.setContentView(new FileSelectView(context, id, callback,
                suffix, headstr, images));
    ...
    static class FileSelectView extends ListView implements OnItemClickListener {
        ...
        public FileSelectView(Context context, int dialogid,
                              CallbackBundle callback, String suffix, String headstr,
        ...
        private int refreshFileList() {
            ...
            if (files == null) {
                // 访问出错
                AleartDialogHelper.alToast(getContext(), sOnErrorMsg, 1000);
                return -1;
            }
            if (list != null) {
                list.clear();
            ...
            for (File file : files) {
                if (file.isDirectory() && file.listFiles() != null) {
                    ...
                    if (headstr == ""
                            || (file.getName().length() > headstr.length() && file
                            .getName().substring(0, headstr.length()) .contentEquals(headstr) )) {
            ...
            // BoardUpdateAdapter adapter=new BoardUpdateAdapter(getContext(),
            // list);
