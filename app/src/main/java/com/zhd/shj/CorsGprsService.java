...
import com.zhd.zhdcorsnet.StateBroadcast;
...
public class CorsGprsService extends Service {
  ...
  //  private GnssDataReceive mGnssDataReceive = null;
    ...
    public void ConnectServer() {
        try {
            ...
            mStrHead += "User-Agent: GNSSInternetRadio/1.4.10\r\n";
            mStrHead += "Accept: */*\r\nConnection: close\r\n";
            mStrHead += "Authorization: Basic " + auth + "\r\n";
            mStrHead += "\r\n";
Log.e("COS","结果"+mStrHead);
