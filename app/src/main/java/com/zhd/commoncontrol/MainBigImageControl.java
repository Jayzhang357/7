 ...
 *
 */
@SuppressLint("ResourceAsColor") public class MainBigImageControl extends LinearLayout {

	private ImageView mImgView = null;
	private Context mContext;
	private int mImgResourceId = 0;
	public TextView t1;
	public MainBigImageControl(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		LayoutInflater.from(context).inflate(R.layout.contorl_big_imgbutton, this, true);
		mContext = context;
		...
		t1.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				// 根据高度设置文本大小
				int textSize = textViewHeight/2+2; // 自定义计算文本大小的方法
