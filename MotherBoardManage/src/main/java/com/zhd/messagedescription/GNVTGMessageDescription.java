...
public class GNVTGMessageDescription extends MessageDescription {

	private IParser mParser;
	private int mCount = 0;
	
	public GNVTGMessageDescription(int messageDescriptionType,IParser parser) throws UnsupportedEncodingException {
		super("$GNVTG".getBytes("UTF-8"), messageDescriptionType, (byte) 0x0A, 500);
