...
public class GGAMessageDescription extends MessageDescription {
	...
	public GGAMessageDescription(int messageDescriptionType,IParser parser) throws UnsupportedEncodingException {
		super("$GPGGA".getBytes("UTF-8"), messageDescriptionType, (byte) 0x0A, 500);
