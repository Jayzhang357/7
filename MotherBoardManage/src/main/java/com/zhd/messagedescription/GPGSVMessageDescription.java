...
public class GPGSVMessageDescription extends MessageDescription {
	private IParser mParser;
	
	public GPGSVMessageDescription(int messageDescriptionType, IParser parser) throws UnsupportedEncodingException {
		super("$GPGSV".getBytes("UTF-8"), messageDescriptionType, (byte) 0x0A, 500);
