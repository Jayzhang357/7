...
public class GBGSVMessageDescription extends MessageDescription {
	private IParser mParser;
	
	public GBGSVMessageDescription(int messageDescriptionType, IParser parser) throws UnsupportedEncodingException {
		super("$GBGSV".getBytes("UTF-8"), messageDescriptionType, (byte) 0x0A, 500);
