...
public class GBDGSVMessageDescription extends MessageDescription {
	private IParser mParser;
	
	public GBDGSVMessageDescription(int messageDescriptionType, IParser parser) throws UnsupportedEncodingException {
		super("$GBDGSV".getBytes("UTF-8"), messageDescriptionType, (byte) 0x0A, 500);
