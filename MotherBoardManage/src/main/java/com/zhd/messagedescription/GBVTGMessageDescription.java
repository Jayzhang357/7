...
public class GBVTGMessageDescription extends MessageDescription {

	private IParser mParser;
	private int mCount = 0;

	public GBVTGMessageDescription(int messageDescriptionType, IParser parser) throws UnsupportedEncodingException {
		super("$GBVTG".getBytes("UTF-8"), messageDescriptionType, (byte) 0x0A, 500);
