...
public class UMVersionMessageDescription extends MessageDescription {

	private IParser mParser;
	private int mCount = 0;
	
	public UMVersionMessageDescription(int messageDescriptionType,IParser parser) throws UnsupportedEncodingException {
	...
	public void ResolveReceiveMesssage(byte[] entireMessage){
		mParser.parseUMVersion(entireMessage);
	}
