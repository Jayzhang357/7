...
public class GSVMessageDescription extends MessageDescription {
	private IParser mParser;
	
	public GSVMessageDescription(int messageDescriptionType, IParser parser) throws UnsupportedEncodingException {
		super("$GNGSV".getBytes("UTF-8"), messageDescriptionType, (byte) 0x0A, 500);
