...
public class GNGGAMessageDescription extends MessageDescription {

	private IParser mParser;
	private int mCount = 0;
	
	public GNGGAMessageDescription(int messageDescriptionType,IParser parser) throws UnsupportedEncodingException {
		super("$GNGGA".getBytes("UTF-8"), messageDescriptionType, (byte) 0x0A, 500);
